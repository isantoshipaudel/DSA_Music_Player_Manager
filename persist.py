            ...
            with open(LIBRARY_FILE, "r") as f:
                ...
                for item in data:
                    if os.path.exists(item["filepath"]):
                        loaded_songs.append(Song(item["title"], item["artist"], item["filepath"]))
                self.library = loaded_songs
                self.musicplayer.library = loaded_songs[:]  # update main app
                self.musicplayer.library_manager.songs = loaded_songs[:]  # update manager
